...
namespace Quotes_App.Controllers
{
    public class QuotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("QuoteId,QuoteText,AuhtorFname,AuthorLname,Subject,Cite")] Quote quote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("QuoteId,QuoteText,AuhtorFname,AuthorLname,Subject,Cite")] Quote quote)
        {
            if (id != quote.QuoteId)
            {
                return NotFound();
